...
**/
class TCF_ContactForm_Input_Text
{
  /**
  ...
  public function get($args = [])
  {
    ...
    $input = htmlentities('<input type="'.$type.'" name="tcf_input['.$str_name.'][value][]" id="'.$args['id'].'" class="'.$args['class'].'" '.$is_require.' value="">');
    if($args['is_require']){
